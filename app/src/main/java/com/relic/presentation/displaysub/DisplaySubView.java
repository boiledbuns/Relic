...
public class DisplaySubView extends Fragment {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    ...
    displaySubBinding.setDisplaySubView(this);
...
//    ((TextView) myToolbar.findViewById(R.id.my_toolbar_subtitle)).setText("popular");
  ...
  public void subscribeToSubreddit(View button) {
    LiveData <Boolean> subscribeSuccess = displaySubVM.subscribeToSub();
    subscribeSuccess.observe(this, new Observer<Boolean>() {
      @Override
      public void onChanged(@Nullable Boolean success) {
        if (success != null) {
          ...
          // remove this observer once we have conusmed the event
          subscribeSuccess.removeObserver(this);
        }
      }
    });
  }
