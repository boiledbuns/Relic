...
class DisplaySubView : Fragment() {
    ...
    private lateinit var displaySubBinding: DisplaySubBinding
    ...
    override fun onCreateView(
        ...
        // postAdapter = new PostItemAdapter(displaySubVM, new PostItemOnClick(), new OnClickImage());

        postAdapter = PostItemAdapter(displaySubVM)
        displaySubBinding.apply {
            displayPostsRecyclerview.adapter = postAdapter
            displayPostsRecyclerview.itemAnimator = null
            // initialize the reference to the swiperefresh layout s
        }

        // attach the listeners responsible checking if the user has scrolled to the bottom of the view
        attachScrollListeners()
        initializeActionbar()
        return displaySubBinding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            ...
            if (position == 0) {
                displaySubBinding.displaySubAppbarlayout.setExpanded(true)
            } else {
                displaySubBinding.displaySubAppbarlayout.setExpanded(false)
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        ...
        if (validOption) {
            ...
            displaySubBinding.apply {
                displaySubAppbarlayout.setExpanded(true)
                displayPostsSwipeRefreshLayout.isRefreshing = true
            }
    ...
    private fun bindViewModel() {
        ...
        displaySubVM.postListLiveData.nonNull().observe (this) { postModels ->
            ...
            scrollLocked = false
            displaySubBinding.displayPostsSwipeRefreshLayout.isRefreshing = false
        }
        ...
        displaySubVM.subredditLivedata.nonNull().observe(this) { subredditModel ->
            displaySubBinding.subModel = subredditModel
        }
    ...
    fun attachScrollListeners() {
        ...
        displaySubBinding.displayPostsRecyclerview.addOnScrollListener(object :
        ...
        displaySubBinding.displayPostsSwipeRefreshLayout.setOnRefreshListener {
            // empties current items to show that it's being refreshed
            displaySubBinding.displayPostsRecyclerview.layoutManager!!.scrollToPosition(0)
            postAdapter!!.clear()
    ...
    private fun initializeActionbar() {
        ...
        myToolbar = displaySubBinding.root.findViewById(R.id.display_sub_toolbar)
        appBarLayout = displaySubBinding.root.findViewById(R.id.display_sub_appbarlayout)

        myToolbar!!.title = subName
        myToolbar!!.subtitle = "Sorting by new"

        val parentActivity = activity as AppCompatActivity?
        parentActivity?.setSupportActionBar(myToolbar)

        // set onclick to display sub info when the title is clicked
        appBarLayout!!.findViewById<View>(R.id.display_sub_toolbar).setOnClickListener {
            Toast.makeText(activity, "Title Clicked", Toast.LENGTH_SHORT).show()
        ...
        displaySubBinding.apply {
            displaySubAppbarlayout.addOnAttachStateChangeListener(object :
                    View.OnAttachStateChangeListener {
                override fun onViewAttachedToWindow(view: View) {
                    if (fragmentOpened) {
                        displaySubBanner.visibility = View.GONE
                        displaySubAppbarlayout.setExpanded(false)
                        fragmentOpened = false
                        displaySubBinding.displaySubBanner.visibility = View.VISIBLE
                    }
                }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        val manager =
                displaySubBinding!!.displayPostsRecyclerview.layoutManager as LinearLayoutManager?
